...
"""
# tells python to use arcade
import arcade

# Sets the name and size of the game window
SCREEN_WIDTH = 640
SCREEN_HEIGHT = 480
SCREEN_TITLE = "Move Keyboard Example"
# Defines a variable for movement speed
MOVEMENT_SPEED = 3
...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        # Checks where ball is
    def update(self, delta_time):
        self.ball.update()

        # Moves the ball through space 
    def on_key_press(self, key, modifiers):
        ...
        # Stops moving the ball when you release a key
